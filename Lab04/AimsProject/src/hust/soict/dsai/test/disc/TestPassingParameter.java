...
public class TestPassingParameter {
	...
	public static void main(String[] args) {
        DigitalVideoDisc jungleDVD = new DigitalVideoDisc(1, "Jungle", null, 0, null, 0);
        DigitalVideoDisc cinderellaDVD = new DigitalVideoDisc(2, "Cinderella", null, 0, null, 0);
...
//    }
    ...
    public static void changeTitle(DigitalVideoDisc dvd, String title) {
        ...
        dvd.setTitle(title);
        dvd = new DigitalVideoDisc(3, oldTitle, null, 0, null, 0);
